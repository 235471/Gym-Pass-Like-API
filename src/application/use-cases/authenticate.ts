...
import { AuthenticateUserDTO, UserDTO, UserProfileDTO } from "../dtos/user-dto"; // Import UserProfileDTO
...
type AuthenticateUserUseCaseResponse = Either<IError, AuthenticateSuccessResponse>;
...
export class AuthenticateUseCase {
  ...
  async execute(
    ...
    const createTokenResult = await this.refreshTokenRepository.create(
      refreshTokenData
    );
